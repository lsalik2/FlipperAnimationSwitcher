...
void fas_scene_main_menu_on_enter(void* context) {
    ...
    menu_add_item(app->menu, "Edit Playlist",   &I_create, FasMainIdxEdit,    fas_main_menu_cb, app);
    ...
    menu_add_item(app->menu, "Default Values",  &I_create, FasMainIdxDefaults, fas_main_menu_cb, app);
...
bool fas_scene_main_menu_on_event(void* context, SceneManagerEvent event) {
    ...
    if(event.type == SceneManagerEventTypeCustom) {
        ...
        case FasMainIdxChoose:
            ...
            break;
        case FasMainIdxEdit:
            scene_manager_next_scene(app->scene_manager, FasSceneEditPlaylist);
            consumed = true;
            break;
        ...
        case FasMainIdxDelete:
            ...
            consumed = true;
            break;
        case FasMainIdxDefaults:
            scene_manager_next_scene(app->scene_manager, FasSceneDefaults);
            consumed = true;
            break;
